...
char * const U32PROPERTY1NAME;
module_param (U32PROPERTY1NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY1NAME, "U32 platform data entry 1");

char * const U32PROPERTY2NAME;
module_param (U32PROPERTY2NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY2NAME, "U32 platform data entry 2");

char * const U32PROPERTY3NAME;
module_param (U32PROPERTY3NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY3NAME, "U32 platform data entry 3");

char * const U32PROPERTY4NAME;
module_param (U32PROPERTY4NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY4NAME, "U32 platform data entry 4");

char * const U32PROPERTY5NAME;
module_param (U32PROPERTY5NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY5NAME, "U32 platform data entry 5");

char * const U32PROPERTY6NAME;
module_param (U32PROPERTY6NAME, charp, 0000);
MODULE_PARM_DESC (U32PROPERTY6NAME, "U32 platform data entry 6");

uint U32PROPERTY1VALUE = 0;
module_param (U32PROPERTY1VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY1VALUE, "U32 platform data entry 1");

uint U32PROPERTY2VALUE = 0;
module_param (U32PROPERTY2VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY2VALUE, "U32 platform data entry 2");

uint U32PROPERTY3VALUE = 0;
module_param (U32PROPERTY3VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY3VALUE, "U32 platform data entry 3");

uint U32PROPERTY4VALUE = 0;
module_param (U32PROPERTY4VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY4VALUE, "U32 platform data entry 4");

uint U32PROPERTY5VALUE = 0;
module_param (U32PROPERTY5VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY5VALUE, "U32 platform data entry 5");

uint U32PROPERTY6VALUE = 0;
module_param (U32PROPERTY6VALUE, uint, 0000);
MODULE_PARM_DESC (U32PROPERTY6VALUE, "U32 platform data entry 6");

char *BOOLPROPERTY6NAME;
module_param (BOOLPROPERTY6NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY6NAME, "bool platform data entry 6");

char *BOOLPROPERTY5NAME;
module_param (BOOLPROPERTY5NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY5NAME, "bool platform data entry 5");

char *BOOLPROPERTY4NAME;
module_param (BOOLPROPERTY4NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY4NAME, "bool platform data entry 4");

char *BOOLPROPERTY3NAME;
module_param (BOOLPROPERTY3NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY3NAME, "bool platform data entry 3");

static char *BOOLPROPERTY2NAME;
module_param (BOOLPROPERTY2NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY2NAME, "bool platform data entry 2");

static char *BOOLPROPERTY1NAME;
module_param (BOOLPROPERTY1NAME, charp, 0000);
MODULE_PARM_DESC (BOOLPROPERTY1NAME, "bool platform data entry 1");

bool BOOLPROPERTY6VALUE;
module_param (BOOLPROPERTY6VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY6VALUE, "bool platform data entry 6");

bool BOOLPROPERTY5VALUE;
module_param (BOOLPROPERTY5VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY5VALUE, "bool platform data entry 5");

bool BOOLPROPERTY4VALUE;
module_param (BOOLPROPERTY4VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY4VALUE, "bool platform data entry 4");

bool BOOLPROPERTY3VALUE;
module_param (BOOLPROPERTY3VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY3VALUE, "bool platform data entry 3");

bool BOOLPROPERTY2VALUE;
module_param (BOOLPROPERTY2VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY2VALUE, "bool platform data entry 2");

bool BOOLPROPERTY1VALUE;
module_param (BOOLPROPERTY1VALUE, bool, 0);
MODULE_PARM_DESC (BOOLPROPERTY1VALUE, "bool platform data entry 1");
...
static const struct property_entry mparam_properties[] = {

//if (U32PROPERTY1NAME) && (U32PROPERTY1VALUE) {
	PROPERTY_ENTRY_U32(U32PROPERTY1NAME, U32PROPERTY1VALUE),
//	}
/*
//if (U32PROPERTY2NAME) && (U32PROPERTY2VALUE) {
	PROPERTY_ENTRY_U32 (U32PROPERTY2NAME, U32PROPERTY2VALUE),
//	}
//if (U32PROPERTY3NAME) && (U32PROPERTY3VALUE) {
	PROPERTY_ENTRY_U32 (U32PROPERTY3NAME, U32PROPERTY3VALUE),
//	}
//if (U32PROPERTY4NAME) && (U32PROPERTY4VALUE) {
	PROPERTY_ENTRY_U32 (U32PROPERTY4NAME, U32PROPERTY4VALUE),
//	}
//if (U32PROPERTY5NAME) && (U32PROPERTY5VALUE) {
	PROPERTY_ENTRY_U32 (U32PROPERTY5NAME, U32PROPERTY5VALUE),
//	}
//if (U32PROPERT6NAME) && (U32PROPERTY6VALUE) {
	PROPERTY_ENTRY_U32 (U32PROPERTY6NAME, U32PROPERTY6VALUE),
//	}
//if (BOOLPROPERT6NAME) && (BOOLPROPERTY6VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY6NAME,BOOLPROPERTY6VALUE)),
//    }
//if (BOOLPROPERT5NAME) && (BOOLPROPERTY5VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY5NAME, BOOLPROPERTY5VALUE)),
//    }
//if (BOOLPROPERT4NAME) && (BOOLPROPERTY4VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY4NAME, BOOLPROPERTY4VALUE)),
//    }
//if (BOOLPROPERT3NAME) && (BOOLPROPERTY3VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY3NAME, BOOLPROPERTY3VALUE)),
//    }
//if (BOOLPROPERT2NAME) && (BOOLPROPERTY2VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY2NAME, BOOLPROPERTY2VALUE)),
//    }
//if (BOOLPROPERT1NAME) && (BOOLPROPERTY1VALUE) {
    PROPERTY_ENTRY_BOOL ((BOOLPROPERTY1NAME, BOOLPROPERTY1VALUE)),
//    }
*/
	{}
};

static const struct software_node mparam_node = {
	.properties = mparam_properties,
};
...
//    printk("spi_tiny_usb Start of platform probe\n");
	...
	strcpy((char * const)pd->spi_info[0].swnode->properties[0].name, U32PROPERTY1NAME);
	pd->spi_info[0].swnode->properties[0].value.u32_data[0] = {U32PROPERTY2VALUE};
//	memcpy(pd->spi_info[0].swnode->properties[0].value.u32_data[0], U32PROPERTY2VALUE, sizeof(U32PROPERTY2VALUE));
