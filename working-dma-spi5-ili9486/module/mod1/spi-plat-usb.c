...
//			spi_flags |= FLAGS_END;
        ...
        iops->setup_data(priv->intf, 67, (t->speed_hz / 10000), (t->speed_hz / 10000), NULL, 0);
...
// IF TX and RX
		...
		iops->setup_data(priv->intf, 65, 508, 508, NULL, 0);
		...
		iops->setup_data(priv->intf, 65, temp, temp, NULL, 0);
		...
		iops->unlock(priv->intf);
            ...
            iops->setup_data(priv->intf, 65, t->len, t->len, NULL, 0);
