...
void usbuart_set_line_coding(struct usb_cdc_line_coding *coding, usbd_device *usbd_dev)
{
//RCC_BDCR >> RCC_BDCR_RTCSEL_SHIFT |= (0x3 << RCC_BDCR_RTCSEL_HSE);(PWR_SRDCR_VOS_MASK << PWR_SRDCR_VOS_SHIFT);
...
char test[] = {"poooooooooop\n\r"};
usbd_ep_write_packet(usbd_dev, 0x85, test, sizeof(test));
...
static void cdcacm_set_config(usbd_device *usbd_dev, uint16_t wValue)
{
	...
	usbd_ep_setup(usbd_dev, 0x85, USB_ENDPOINT_ATTR_BULK, CDCACM_PACKET_SIZE, NULL);
...
//	 MPU_CTRL = 0;
//	 ARM_MPU_SetRegionEx(0UL, 0x24000000UL, ARM_MPU_RASR(0UL, ARM_MPU_AP_FULL, 0UL, 0UL, 1UL, 0UL, 0x00UL, ARM_MPU_REGION_SIZE_256K));
//	ARM_MPU_Enable(MPU_CTRL_PRIVDEFENA_Msk);

//	 MPU_CTRL = 1;
  // Set Region 0
//  ARM_MPU_SetRegionEx(1UL, 0x24000000UL, ARM_MPU_RASR(0UL, ARM_MPU_AP_FULL, 0UL, 0UL, 1UL, 1UL, 0x00UL, ARM_MPU_REGION_SIZE_512KB));
